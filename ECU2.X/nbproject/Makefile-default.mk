...
SOURCEFILES_QUOTED_IF_SPACED=clcd.c adc.c ecu2_main.c digital_keypad.c can.c functions.c matrix_keypad.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/ecu2_main.p1 ${OBJECTDIR}/digital_keypad.p1 ${OBJECTDIR}/can.p1 ${OBJECTDIR}/functions.p1 ${OBJECTDIR}/matrix_keypad.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/clcd.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/ecu2_main.p1.d ${OBJECTDIR}/digital_keypad.p1.d ${OBJECTDIR}/can.p1.d ${OBJECTDIR}/functions.p1.d ${OBJECTDIR}/matrix_keypad.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/ecu2_main.p1 ${OBJECTDIR}/digital_keypad.p1 ${OBJECTDIR}/can.p1 ${OBJECTDIR}/functions.p1 ${OBJECTDIR}/matrix_keypad.p1

# Source Files
SOURCEFILES=clcd.c adc.c ecu2_main.c digital_keypad.c can.c functions.c matrix_keypad.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/ECU2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/ECU2.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp=${DFP_DIR}/xc8  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/ECU2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
