...
# 1 "./msg_id.h" 1
# 16 "./message_handler.h" 2
# 25 "./message_handler.h"
...
unsigned short int get_gear_position()
{
    clcd_print("GP", (0x80 + (3)));
    _delay((unsigned long)((100)*(20000000/4000000.0)));
    if (can_receive(&id, &data_length, data) && id == 0x20)
    {
        clcd_putch(data[0], (0xC0 + (3)));
        clcd_putch(data[1], (0xC0 + (4)));
    }
}

unsigned short int get_engine_temp()
{
    clcd_print("ET", (0x80 + (6)));
    if (can_receive(&id, &data_length, data) && id == 0x30)
    {
        clcd_putch(data[0], (0xC0 + (6)));
        clcd_putch(data[1], (0xC0 + (7)));
    }
}

unsigned short int get_indicator_status()
{
    clcd_print("IS",(0x80 + (9)));
    _delay((unsigned long)((100)*(20000000/4000000.0)));
    if (can_receive(&id, &data_length, data) && id == 0x40)
    {
        clcd_putch(data[0], (0xC0 + (9)));
...
unsigned int get_rpm()
{
    clcd_print("RPM",(0x80 + (12)));
    _delay((unsigned long)((100)*(20000000/4000000.0)));
    if (can_receive(&id, &data_length, data) && id == 0x50)
    {
        clcd_putch(data[0], (0xC0 + (12)));
        clcd_putch(data[1], (0xC0 + (13)));
        clcd_putch(data[2], (0xC0 + (14)));
        clcd_putch(data[3], (0xC0 + (15)));
    }
}
